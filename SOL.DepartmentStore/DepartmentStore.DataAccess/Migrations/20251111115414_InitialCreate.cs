    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("55555555-5555-5555-5555-555555555555"), null, new DateTime(2025, 1, 1, 7, 0, 0, 0, DateTimeKind.Local), "System Administrator with full access", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "Description", "IsDeleted", "Name", "UpdatedAt" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 1, 1, 7, 0, 0, 0, DateTimeKind.Local), "Default category for uncategorized products", false, "General", null });

            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "Id", "Address", "CreatedAt", "Email", "IsDeleted", "Name", "Phone", "UpdatedAt" },
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "123 Default St, Hanoi, Vietnam", new DateTime(2025, 1, 1, 7, 0, 0, 0, DateTimeKind.Local), "supplier@example.com", false, "Default Supplier", "0123456789", null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedAt", "Description", "IsDeleted", "Name", "Price", "SupplierId", "UpdatedAt" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 1, 1, 7, 0, 0, 0, DateTimeKind.Local), "This is a demo product for testing", false, "Sample Product", 99.99m, new Guid("22222222-2222-2222-2222-222222222222"), null });
